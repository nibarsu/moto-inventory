    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('purchase-orders.store') }}" class="space-y-6 p-6">
                    @csrf

                    <div class="grid gap-6 sm:grid-cols-2">
                        <div>
                            <x-input-label for="po_no" value="進貨單號" />
                            <x-text-input id="po_no" name="po_no" type="text" class="mt-1 block w-full" :value="old('po_no')" required autofocus />
