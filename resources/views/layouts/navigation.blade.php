<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('stocks.adjust')" :active="request()->routeIs('stocks.adjust')">
                        庫存調整
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('stock-movements.index')" :active="request()->routeIs('stock-movements.index')">
                庫存異動
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('stocks.adjust')" :active="request()->routeIs('stocks.adjust')">
                庫存調整
            </x-responsive-nav-link>
