<div class="rounded-md bg-gray-50 p-4 text-sm text-gray-700">
    銷貨單號：{{ $salesOrder->so_no }}
</div>

<div>
    <x-input-label for="item_type" value="類型" />
    <select id="item_type" name="item_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" onchange="toggleSalesItemSelects()" required>
...
<div id="part-item-select-wrapper">
    ...
    <select id="part_item_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" onchange="syncSalesItem()">
        <option value="">請選擇零件商品</option>
...
<div id="vehicle-item-select-wrapper">
    ...
    <select id="vehicle_item_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" onchange="syncSalesItem()">
        <option value="">請選擇整車商品</option>
...
<script>
    function toggleSalesItemSelects() {
