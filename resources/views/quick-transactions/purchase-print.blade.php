...
<body>
    <div class="sheet">
        ...
        <div class="header">
            <div>
                <div class="title">進貨單</div>
                <div>單號：{{ $purchaseReceipt->receipt_no }}</div>
            </div>
            <div>日期：{{ optional($purchaseReceipt->receipt_date)->format('Y-m-d') }}</div>
        </div>

        <table class="meta">
            <tr>
                <td width="15%">供應商</td>
                <td width="35%">{{ $purchaseReceipt->supplier?->name }}</td>
                <td width="15%">倉庫</td>
                <td width="35%">{{ $purchaseReceipt->warehouse?->name }}</td>
            </tr>
            <tr>
                <td>備註</td>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">{{ number_format((float) $purchaseReceipt->total_amount, 2) }}</td>
                </tr>
            </tbody>
        </table>

        <div class="footer">
            <div class="sign">供應商簽章</div>
